<script>
    ...
    const saveElementUser = async () => {
        await updateDoc(doc(db, "users", user.id), user);
        await loadDataUsers();
        vaciarFormulario();
    };

    const editElementUser = (p) => {
        user = Object.assign({}, p);
        editar = true;
    };

    const deleteElementUser = async (id) => {
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="p-4 rounded-md text-left">
                ...
                <form on:submit|preventDefault={onSubmitHandler}>
                    ...
                    <select bind:value={user.category} id="category">
                        ...
                        >
                            ...
                            <div class="flex justify-start space-x-2">
                                ...
                                <button
                                    ...
                                    on:click={deleteElementUser(u.id)}
                                    ><svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="h-6 w-6"
                                        fill="none"
